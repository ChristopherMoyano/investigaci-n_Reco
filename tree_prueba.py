...
def asignaciones(params,num_exp,checkpoint_every,tag_df,tag_num_tex):
    ...
    def log(msg):
        ...
        print(f"[{ts}][splitter ={splitter_v},max_features={max_features_v},max_depth = {max_depth_v}, \
               min_samples_leaf = {min_samples_leaf_v}] {msg}",flush=True)
    
    splitter_v, max_features_v, max_depth_v,min_samples_leaf_v = params
    combo_id = f"splitter ={splitter_v},max_features={max_features_v},max_depth = {max_depth_v}, \
